...
// AuthProxyRoleBinding scaffolds the config/rbac/auth_proxy_role_binding.yaml file
...
var (
	// This ensure the AuthProxyRoleBinding implements the KB pkg/model/file.Template interface.
	_ file.Template = &AuthProxyRoleBinding{}
)
