...
const (
	testNamespaceName = "terraform-test"
)
...
func TestSetCondition(t *testing.T) {
	...
	newStatus, err := newTestStatus().SetCondition(TFConfigCondition{
...
func TestStatusForEmpty(t *testing.T) {
	...
	assert.Equal(t, &TFConfigStatus{}, status)
}
...
func TestStatusForFilledRaw(t *testing.T) {
	...
	assert.Equal(t, "SomeConfig", status.DeployedConfig.Name)
}
...
func newTestStatus() *TFConfigStatus {
	return &TFConfigStatus{
		Conditions: []TFConfigCondition{
			{
				Type:               ConditionDeployed,
				Status:             StatusTrue,
		...
		DeployedConfig: &TFDeploy{Name: "SomeConfig"},
	}
}
...
func newTestStatusRaw() map[string]interface{} {
	return map[string]interface{}{
		...
		"deployedConfig": map[string]interface{}{"name": "SomeConfig"},
	}
}
